...
/**
 * help_alias - shows information on the shellby builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - shows information on the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_help - shows information on the shellby builtin command 'help'.
 */
void help_help(void)
{
